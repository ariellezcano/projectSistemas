...
@Component({
  selector: 'app-fil-solicitud-sistemas',
  templateUrl: './fil-solicitud-sistemas.component.html',
  styleUrls: ['./fil-solicitud-sistemas.component.scss']
})
export class FilSolicitudSistemasComponent implements OnInit {
