...
@Component({
  selector: 'app-fil-servidores',
  templateUrl: './fil-servidores.component.html',
  styleUrls: ['./fil-servidores.component.scss'],
})
export class FilServidoresComponent implements OnInit {
  @Output() emmit: EventEmitter<Servidores[]> = new EventEmitter();
