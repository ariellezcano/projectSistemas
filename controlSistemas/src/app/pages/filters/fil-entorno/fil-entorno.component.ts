...
@Component({
  selector: 'app-fil-entorno',
  templateUrl: './fil-entorno.component.html',
  styleUrls: ['./fil-entorno.component.scss']
})
export class FilEntornoComponent implements OnInit {

  @Output() emmit: EventEmitter<EntornoLenguaje[]> = new EventEmitter();
