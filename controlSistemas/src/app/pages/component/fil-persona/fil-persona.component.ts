...
import { DatoPolicialService } from 'src/app/services/component/dato-policial.service';
  ...
  async buscar() {
    ...
    if (result.status === 200) {
      ...
      if (this.items.length == 1) {
        ...
        this.criterio = this.item.persona.norDni +" - "+this.item.persona.apellido +" "+this.item.persona.nombre
