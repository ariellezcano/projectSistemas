...
@Component({
  selector: 'app-abm-tipo-servidor',
  templateUrl: './abm-tipo-servidor.component.html',
  styleUrls: ['./abm-tipo-servidor.component.scss']
})
export class AbmTipoServidorComponent implements OnInit {
  ...
  constructor(
    ...
    private wsdl: TipoServidorService,
  ...
  async actualizarDatos(obj: TipoServidor) {
  ...
  back() {
    this.router.navigate(['/lst-tipoServidor']);
  }
