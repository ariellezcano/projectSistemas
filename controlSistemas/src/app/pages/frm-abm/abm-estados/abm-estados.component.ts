...
@Component({
  selector: 'app-abm-estados',
  templateUrl: './abm-estados.component.html',
  styleUrls: ['./abm-estados.component.scss']
})
export class AbmEstadosComponent implements OnInit {
  ...
  async actualizarDatos(obj: Estados) {
  ...
  back() {
    this.router.navigate(['/lst-estados']);
  }
}
